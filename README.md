...
<p align="center">
<a href="https://packagist.org/packages/paul/eventu"><img src="https://poser.pugx.org/paul/eventu/downloads" alt="Total Downloads"></a>
<a href="https://packagist.org/packages/paul/eventu"><img src="https://poser.pugx.org/paul/eventu/v/stable" alt="Latest Stable Version"></a>
<a href="https://packagist.org/packages/paul/eventu"><img src="https://poser.pugx.org/paul/eventu/license" alt="License"></a>
</p>
...
- [paul/laravel-menu](https://github.com/paul/laravel-menu)
...
- `docker run --rm -v "$(pwd)":/opt -w /opt laravelsail/php83-composer:latest bash -c "composer create-project paul/eventu admin-app && cd admin-app && php artisan sail:install --with=mysql,redis,meilisearch,mailpit,selenium"`
- `cd admin-app`
...
- `composer create-project paul/eventu admin-app`
- `cd admin-app`
...
- [Basic Laravel Admin Panel - Build with Blade template](https://github.com/paul/basic-laravel-admin-panel)
