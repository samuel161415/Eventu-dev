  ...
  <LayoutAuthenticated>
    ...
    <SectionMain>
      <SectionTitleLineWithButton :icon="mdiAccountKey" title="Users" main>
        <BaseButton v-if="can.delete" :route-name="route('admin.user.create')" :icon="mdiPlus" label="Add" color="info"
          rounded-full small />
      </SectionTitleLineWithButton>
      <NotificationBar :key="Date.now()" v-if="$page.props.flash.message" color="success" :icon="mdiAlertBoxOutline">ear
            ...
            <tr v-for="user in users.data" :key="user.id">
              ...
              <td v-if="can.edit || can.delete" class="before:hidden lg:w-1 whitespace-nowrap">
                <BaseButtons type="justify-start lg:justify-end" no-wrap>
                  <BaseButton v-if="can.edit" :route-name="route('admin.user.edit', user.id)" color="info"
